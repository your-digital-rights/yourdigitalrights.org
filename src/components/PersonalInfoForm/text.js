...
export const IntroText = (
      <FormattedMessage
        id="IntroText"
        defaultMessage="To send a request please fill in the following information which will help the organization locate your data. Submitting this form will generate an email which you can review and then send. This website does not keep any of the information entered."
      />
);
