                ...
                <Paper className={classes.inner}>
                    ...
                    <Typography gutterBottom={true}>
                        <FormattedMessage
                            ...
                            values={{
                                linkedin: (
                                    <a href="https://www.linkedin.com/in/yoava">
                                        Yoav Aviram
                                    </a>
                                ),
                            }}
                    ...
                    <Typography gutterBottom={true}>
                        <FormattedMessage
                            ...
                            values={{
                                linkedin: (
                                    <a href="https://www.linkedin.com/in/rafaprada">
                                        Rafa Prada
                                    </a>
                                ),
                            }}
                    ...
                    <Typography gutterBottom={true}>
                        <FormattedMessage
                            ...
                            values={{
                                featureupvote: (
                                    <a href="https://featureupvote.com">
                                        FeatureUpvote
                                    </a>
                                ),
                                roadmap: (
                                    <a href="https://wishlist.opt-out.eu">
                                        roadmap
                                    </a>
                                ),
                            }}
                    ...
                    <Typography gutterBottom={true}>
                        <FormattedMessage
                            ...
                            values={{
                                featureupvote: (
                                    <a href="https://www.bablic.com">Bablic</a>
                                ),
                            }}
                        />
                    </Typography>
